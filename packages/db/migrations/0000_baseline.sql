...
--
-- Name: activity_chain_head; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.activity_chain_head (
    id integer NOT NULL,
...
--
-- Name: activity_events_default; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.activity_events_default (
    seq bigint NOT NULL,
    occurred_at timestamp with time zone NOT NULL,
    kind text NOT NULL,
    correlation_id uuid,
...
--
-- Name: activity_events_default; Type: TABLE ATTACH; Schema: public; Owner: -
--

ALTER TABLE ONLY public.activity_events ATTACH PARTITION public.activity_events_default DEFAULT;
...
--
-- Name: activity_chain_head activity_chain_head_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.activity_chain_head
    ADD CONSTRAINT activity_chain_head_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.activity_events
    ADD CONSTRAINT activity_events_pkey PRIMARY KEY (seq, occurred_at);

--
-- Name: activity_events_default activity_events_default_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.activity_events_default
    ADD CONSTRAINT activity_events_default_pkey PRIMARY KEY (seq, occurred_at);
...
--
-- Name: activity_events_actor_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX activity_events_actor_idx ON ONLY public.activity_events USING btree (actor_id, occurred_at);

--
-- Name: activity_events_company_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX activity_events_company_idx ON ONLY public.activity_events USING btree (company_id, occurred_at);

--
-- Name: activity_events_correlation_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX activity_events_correlation_idx ON ONLY public.activity_events USING btree (correlation_id);

--
-- Name: activity_events_default_actor_id_occurred_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX activity_events_default_actor_id_occurred_at_idx ON public.activity_events_default USING btree (actor_id, occurred_at);

--
-- Name: activity_events_default_company_id_occurred_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX activity_events_default_company_id_occurred_at_idx ON public.activity_events_default USING btree (company_id, occurred_at);

--
-- Name: activity_events_default_correlation_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX activity_events_default_correlation_id_idx ON public.activity_events_default USING btree (correlation_id);
...
--
-- Name: uq_bank_recon_adjustment; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_bank_recon_adjustment ON public.bank_reconciliation_adjustments USING btree (company_id, month, row_key);
...
--
-- Name: activity_events_default_actor_id_occurred_at_idx; Type: INDEX ATTACH; Schema: public; Owner: -
--

ALTER INDEX public.activity_events_actor_idx ATTACH PARTITION public.activity_events_default_actor_id_occurred_at_idx;

--
-- Name: activity_events_default_company_id_occurred_at_idx; Type: INDEX ATTACH; Schema: public; Owner: -
--

ALTER INDEX public.activity_events_company_idx ATTACH PARTITION public.activity_events_default_company_id_occurred_at_idx;

--
-- Name: activity_events_default_correlation_id_idx; Type: INDEX ATTACH; Schema: public; Owner: -
--

ALTER INDEX public.activity_events_correlation_idx ATTACH PARTITION public.activity_events_default_correlation_id_idx;

--
-- Name: activity_events_default_pkey; Type: INDEX ATTACH; Schema: public; Owner: -
--

ALTER INDEX public.activity_events_pkey ATTACH PARTITION public.activity_events_default_pkey;
