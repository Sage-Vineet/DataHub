...
import WorkspaceChatbot from "../../pages/broker/workspace/WorkspaceChatbot";
...
function WorkspaceTopbar({ company, onMenuClick }) {
  ...
  const title = useMemo(() => {
    ...
    if (location.pathname.endsWith("/tax-reconciliation")) return "Tax Reconciliation";
    if (location.pathname.endsWith("/valuation")) return "Valuation";
