...
const COLUMNS = {
  ...
  general_ledger: [
    ...
    { key: "distribution_account",label: "Dist. Account",  w: 160, render: fmtText },
    { key: "transaction_date",    label: "Date",            w: 96,  render: fmtDate },
    { key: "transaction_type",    label: "Type",            w: 100, render: fmtText },
    { key: "transaction_num",     label: "Num",             w: 80,  render: fmtText },
    { key: "transaction_name",    label: "Name",            w: 140, render: fmtText },
    { key: "memo_description",    label: "Memo",            grow: true, render: fmtText },
