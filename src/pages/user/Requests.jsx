...
import { CheckCircle2, Clock3, Eye, FileText, Filter, Send, ShieldCheck, XCircle } from 'lucide-react';
import { useAuth } from '../../context/AuthContext';
import { useToast } from '../../context/ToastContext';
import NewRequestModal from '../../components/NewRequestModal';
import { createCompanyRequestItem, listCompanyRequests, listFolderTree } from '../../lib/api';
    ...
    try {
      const responses = await Promise.all(
        assignedCompanies.map(async (company) => {
          ...
          return companyRequests.map((request) => ({
            id: request.id,
        ...
        <div className="mt-5 overflow-x-auto">
          <table className="w-full min-w-[900px]">
            ...
            <tbody>
              {loading ? (
                <tr>
                  <td colSpan={6} className="px-4 py-10 text-center text-sm text-[#A5A5A5]">
                    Loading requests...
                  </td>
                </tr>
