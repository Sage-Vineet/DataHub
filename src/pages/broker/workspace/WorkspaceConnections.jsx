...
export default function WorkspaceConnections() {
  ...
  const handleSync = async () => {
    ...
    try {
      ...
      setErrorMessage(
        "Token refresh failed. Your session may have expired — try reconnecting.",
      );
    } finally {
      setIsSyncing(false);
    }
  ...
  const isNameMismatch =
    ...
    workspaceNameClean &&
    qbNameClean &&
    workspaceNameClean !== qbNameClean;
        ...
        <div className="card-base overflow-hidden">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              {pageState === "error" && (
                <AlertCircle size={16} className="text-[#C62026]" />
              )}
              <span
                className={cn(
