    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="text-sm text-[#6D6E71] mt-0.5">
            The first reminder is sent when the request is generated. Priority then controls the automatic follow-up cadence until the due date, and you can still send a manual reminder again from here.
          </p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="rounded-2xl border border-dashed border-gray-200 bg-white px-6 py-14 text-center shadow-card">
          ...
          <p className="mt-1 text-xs text-[#A5A5A5]">Once requests are created or broker-approved, reminder tracking will appear here.</p>
        </div>
      ) : (
