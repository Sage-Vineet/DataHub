...
DROP INDEX IF EXISTS idx_bs_entries_coa;
ALTER TABLE balance_sheet_entries DROP COLUMN IF EXISTS sub_section;
ALTER TABLE balance_sheet_entries DROP COLUMN IF EXISTS coa_id;
ALTER TABLE balance_sheet_entries DROP COLUMN IF EXISTS is_generated;
