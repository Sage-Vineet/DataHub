...
Key Report *versions* for DataHub: how a company's report versions are listed, created (auto-numbered),
read, updated, duplicated, activated, and deleted, and how exactly one version is the official (active)
one. This is the first slice of the reports decomposition; the GL computation/sync stays on legacy.
