...
In-app messaging for DataHub: per-company conversations, 1:1 direct messages, and topic message-groups
with membership and unread tracking. Parity with legacy (auto-created groups and thread/contacts
aggregations are out of scope).
