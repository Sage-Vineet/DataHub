...
## Purpose
Broker↔client requests for DataHub: how document/narrative requests are created (single and bulk), validated, listed, updated, approved, and deleted, how reminder frequency follows priority, and how a request carries a narrative and links to fulfilling documents. Parity with legacy (reminder *delivery* is out of scope).
## Requirements
