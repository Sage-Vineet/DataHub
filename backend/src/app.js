...
const asposeSlidesPocRoutes = require("./routes/asposeSlidesPoc");
const asposeSlidesExportRoutes = require("./routes/asposeSlidesExport");
...
app.use("/", asposeSlidesPocRoutes);
app.use("/", asposeSlidesExportRoutes);
