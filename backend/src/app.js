...
const cimCustomTemplateRoutes = require("./routes/cimCustomTemplates");
const cimTemplateLearningRoutes = require("./routes/cimTemplateLearning");
...
app.use("/", cimCustomTemplateRoutes);
app.use("/", cimTemplateLearningRoutes);
